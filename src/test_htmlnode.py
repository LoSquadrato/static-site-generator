...
class TestHTMLNode(unittest.TestCase):
    def test_eq(self):
        node = HTMLNode("a", "proviamo così", None, {"href": "https://www.google.com"})
        node2 = HTMLNode("a", "proviamo così", None, {"href": "https://www.google.com"})
    ...
    def test_leaf_to_html_p(self):
        node = LeafNodeLeafNode("a", "Click me!", {"href": "https://www.google.com"})
